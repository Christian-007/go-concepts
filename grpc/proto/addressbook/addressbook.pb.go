...
func (PhoneType) Descriptor() protoreflect.EnumDescriptor {
	return file_grpc_addressbook_proto_enumTypes[0].Descriptor()
}

func (PhoneType) Type() protoreflect.EnumType {
	return &file_grpc_addressbook_proto_enumTypes[0]
}
...
func (PhoneType) EnumDescriptor() ([]byte, []int) {
	return file_grpc_addressbook_proto_rawDescGZIP(), []int{0}
}
...
func (x *Person) Reset() {
	*x = Person{}
	mi := &file_grpc_addressbook_proto_msgTypes[0]
...
func (x *AddressBook) Reset() {
	*x = AddressBook{}
	mi := &file_grpc_addressbook_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AddressBook) Descriptor() ([]byte, []int) {
	return file_grpc_addressbook_proto_rawDescGZIP(), []int{1}
}
...
func (*Person_PhoneNumber) Descriptor() ([]byte, []int) {
	return file_grpc_addressbook_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_grpc_addressbook_proto protoreflect.FileDescriptor

const file_grpc_addressbook_proto_rawDesc = "" +
	"\n" +
	"\x16grpc/addressbook.proto\x12\vaddressbook\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8d\x02\n" +
	"\x06Person\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x05R\x02id\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x127\n" +
	"\x06phones\x18\x04 \x03(\v2\x1f.addressbook.Person.PhoneNumberR\x06phones\x12=\n" +
...
var (
	...
	file_grpc_addressbook_proto_rawDescData []byte
)

func file_grpc_addressbook_proto_rawDescGZIP() []byte {
	file_grpc_addressbook_proto_rawDescOnce.Do(func() {
		file_grpc_addressbook_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_grpc_addressbook_proto_rawDesc), len(file_grpc_addressbook_proto_rawDesc)))
	})
	return file_grpc_addressbook_proto_rawDescData
}
...
func init() { file_grpc_addressbook_proto_init() }
func file_grpc_addressbook_proto_init() {
	if File_grpc_addressbook_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_grpc_addressbook_proto_enumTypes,
		MessageInfos:      file_grpc_addressbook_proto_msgTypes,
	}.Build()
	File_grpc_addressbook_proto = out.File
	file_grpc_addressbook_proto_goTypes = nil
	file_grpc_addressbook_proto_depIdxs = nil
}
