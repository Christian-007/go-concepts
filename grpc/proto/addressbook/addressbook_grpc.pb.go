...
const (
	AddressBookService_GetAll_FullMethodName = "/addressbook.AddressBookService/GetAll"
)
...
type AddressBookServiceClient interface {
	GetAll(ctx context.Context, in *GetAllParams, opts ...grpc.CallOption) (*AddressBook, error)
}
...
func (c *addressBookServiceClient) GetAll(ctx context.Context, in *GetAllParams, opts ...grpc.CallOption) (*AddressBook, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddressBook)
	err := c.cc.Invoke(ctx, AddressBookService_GetAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AddressBookServiceServer interface {
	GetAll(context.Context, *GetAllParams) (*AddressBook, error)
...
func (UnimplementedAddressBookServiceServer) GetAll(context.Context, *GetAllParams) (*AddressBook, error) {
...
func _AddressBookService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AddressBookService_GetAll_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AddressBookServiceServer).GetAll(ctx, req.(*GetAllParams))
	}
...
var AddressBookService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "grpc/addressbook.proto",
}
